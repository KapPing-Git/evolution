...
public:
  ...
  QSizeF autoChangeMinimumFhysicalViewSize() const;
  void setAutoChangeMinimumFhysicalViewSize(const QSizeF &autoChangeMinimumFhysicalViewSize);
...
private:
  ...
  bool m_visible;
  QSizeF m_autoChangeMinimumFhysicalViewSize;
};
