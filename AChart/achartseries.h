...
public:
  ...
  bool getUseOptimisation() const;
  void setUseOptimisation(bool useOptimisation);
...
private:
  ...
  void addPointToOptimalSeries(QPointF point);
...
//  QPointF m_lastPointMax,m_lastPointMin;
  qreal m_screenPerPhysX;
//  int m_currScreenX,m_startX;
  bool m_anyPointChanged;
