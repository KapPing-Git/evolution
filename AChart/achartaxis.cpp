  ...
  QObject(parent)
{
  ...
  m_color = color;
  m_visible = true;
  m_autoChangeMinimumFhysicalViewSize.setHeight(0);
  m_autoChangeMinimumFhysicalViewSize.setWidth(0);
}
...
QSizeF AChartAxis::autoChangeMinimumFhysicalViewSize() const
{
    return m_autoChangeMinimumFhysicalViewSize;
}

void AChartAxis::setAutoChangeMinimumFhysicalViewSize(const QSizeF &autoChangeMinimumFhysicalViewSize)
{
    m_autoChangeMinimumFhysicalViewSize = autoChangeMinimumFhysicalViewSize;
}
